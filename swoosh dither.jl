...
# ╔═╡ 4e078bde-1cae-11ec-0e19-b31eb78ffce1
using Images

# ╔═╡ 32008057-08c3-4a54-94f8-9d7ccb519ff2
using DitherPunk

# ╔═╡ 1664dad5-ed8f-4d94-8b43-7bad15881046
using Base64

# ╔═╡ e524eec0-91ac-4061-9424-9f4a3c760306
using HypertextLiteral

# ╔═╡ 180aea1a-3d75-4ece-a647-91ed08826384
using PlutoUI

# ╔═╡ 34916290-f1bb-46a9-a755-66a935a6ebd5
import ImageIO

# ╔═╡ 05809407-1c64-438f-9180-c8ba63a6379a
Gray.(rand(20,20))

# ╔═╡ 48d25030-3130-431e-b0f5-e62b627a9197
# @htl("""
# $(PlutoRunner.embed_display(result))
# """)

# ╔═╡ 19175ff5-87f8-4e15-9f34-93e4a909e611
@htl("""
	$(@bind x1 Slider(0:.01:10))
	$(@bind x2 Slider(0:.01:10))

	$(@bind x3 Slider(0:.01:10))
""")

# ╔═╡ 8b9c70b3-ba4b-4a32-afb0-0be4079fe60e
(@bind ca ColorStringPicker()), @bind cb ColorStringPicker()

# ╔═╡ 969dfb90-461e-49c0-acc2-de7f74189882
imgurl(img) = "data:image/png;base64," * base64encode(io -> show(io, MIME"image/png"(), img))

# ╔═╡ cf7dc83d-7a99-4a0b-92a8-cf7adbaa7224
function f(x,y)
	clamp(
...
# ╔═╡ f31a9df7-db04-406a-852e-890e1d741167
base = [
	f(x,y)
	for y in 0:.005:1,
		x in 0:.005:2
...
# ╔═╡ b3f57986-364f-4c2a-98bd-aab5bbc4662b
d = dither(Bool, base, FloydSteinberg());

# ╔═╡ 09175b2a-ed4c-44c5-a066-d835df186150
Gray.(d)

# ╔═╡ c9d49f83-4aed-4b7c-b2f3-94aee611e8f9
result = ifelse.(d, parse(Colorant, ca), parse(Colorant, cb))

# ╔═╡ 41a28bb6-919b-4678-9e3c-16cf339bf291
@htl("""
<style>
body {
overflow-x: hidden;
...
# ╔═╡ be0ae5cd-c455-405a-8abc-83b0990c7059
md"""
...
# ╔═╡ 961be926-6e36-4447-a2d5-c977994f7a4c
#    i want to go here 👉 and not here 👉

# ╔═╡ 686464d9-018a-4525-b105-fa7f4a5cca02
...
[[DitherPunk]]
deps = ["ImageCore", "OffsetArrays", "Random", "TiledIteration"]
git-tree-sha1 = "1ae09d2f60febbb68b9fcc1c84c2acd16b1516e5"
