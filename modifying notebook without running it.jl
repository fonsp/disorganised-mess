...
# ╔═╡ 6613fd4f-02d6-4950-8d13-5af13654ba71
using PlutoUI

# ╔═╡ 5fce3672-ba69-4b6e-bda0-0344b2ebaa54
import Pluto

# ╔═╡ b8d00885-31ea-42f6-ab20-b13288f783be
url = "https://featured.plutojl.org/basic/Tower%20of%20Hanoi.jl"

# ╔═╡ a2325037-ae00-4b9a-8293-9ce91f96dd52
filename = download(url)

# ╔═╡ 1ac902db-62f5-4505-bb76-964581462209
Text(read(filename, String))

# ╔═╡ 93e46889-4469-4fb1-9ccd-1d7cd6c5bc69


# ╔═╡ 5b8d3098-1821-4123-8097-65464bba8429
begin
...
# ╔═╡ f95c1581-c676-4e12-9f8e-8ec466b795af
Pluto.where_referenced(nb.topology, Set([:move]))

# ╔═╡ 1c9bd3b1-40e5-4919-bc14-8d45ce714f62
@bind whichcell_id Slider(nb.cell_order)

# ╔═╡ 6a251dc2-90cc-47e8-bb10-9e329d0f7b54
nb.cells_dict[whichcell_id].code |> Text

# ╔═╡ 2a555b31-76e6-4759-829a-d2914fbf77ba
fav_cell = nb.cells_dict[whichcell_id]

# ╔═╡ 8577f99c-99f3-4439-8d3e-120e6b5f6888
nb.topology.nodes[fav_cell]

# ╔═╡ f46b81fa-ec03-4ac1-aa58-8d97b1d48dde
# nb.cells_dict[whichcell].metadata["luca"] = "ferranti"

# ╔═╡ 2ef7ae25-bd7a-48be-a844-d7e5c3954084
Pluto.save_notebook(nb)

# ╔═╡ 91265b32-59ed-4038-8e57-a7eb69afdbd5
...
julia_version = "1.8.3"
manifest_format = "2.0"
project_hash = "e358cab9b80ced1251b09c5c7df0ee631179801d"
