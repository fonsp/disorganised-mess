...
# ╔═╡ 71b0de06-14a7-49a8-a56d-2b2d06fa323e
using Downloads

# ╔═╡ bbd95e4b-191d-4dab-9c32-372b3e81ab8a
using SHA

# ╔═╡ 2544b37a-13f0-4249-9ffa-eabd10000025
using Base64

# ╔═╡ 91f702b1-8827-4701-a296-155f35f77f33
md"""
Trying to find out how SRI or `integrity` works.

Go to [https://www.jsdelivr.com/package/gh/fonsp/Pluto.jl?path=frontend%2Fcomponents](https://www.jsdelivr.com/package/gh/fonsp/Pluto.jl?path=frontend%2Fcomponents) and click some buttons to find SRI. E.g.
...
# ╔═╡ 263df198-c234-11ec-26cc-5713adc1c504
url = "https://cdn.jsdelivr.net/gh/fonsp/Pluto.jl@0.19.2/frontend/components/Editor.js"

# ╔═╡ 3e59e9f5-2f3c-4ee7-8226-8f575abf68d8
expected = "sha256-KgFxxdVxyecCKKhwIf3dj864YYyk7ZW11rCkI70Si6s=" 

# ╔═╡ 38cf2f46-7073-42ce-a3ba-06d69071302c
content = read(Downloads.download(url))

# ╔═╡ c9ee832c-6636-4d47-9777-684f05014f50
myanswer = "sha256-$(base64encode(SHA.sha256(content)))"

# ╔═╡ 441fa1b3-ddb2-4d92-ae8a-3c3cec4dccef
myanswer == expected

# ╔═╡ 7c8a87e0-e78d-4e0b-9ffb-1ae6106f4685
import PlutoSliderServer

# ╔═╡ 89e997bd-d7c3-4f63-b4a9-46e55da0e569
PlutoSliderServer.plutohash(content)

# ╔═╡ c8f751de-566d-4dd9-bb15-5c485010d0cb
