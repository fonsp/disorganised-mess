...
# ╔═╡ 8fefeb25-742c-4087-97cb-fe6fdc3f1495
using PlutoUI

# ╔═╡ 83b6fb4c-2482-11ee-3358-5941188282b6
import Pluto

# ╔═╡ 29812d79-fcf4-47d8-82ad-cf672a35b762
url = "https://featured.plutojl.org/basic/Tower%20of%20Hanoi.jl"

# ╔═╡ 903dfdd7-45c4-47e8-8a8c-4565b29ad768
filename = download(url)

# ╔═╡ b576129d-7b1b-41cc-8a25-875b0e9b539d
Text(read(filename, String))

# ╔═╡ 283e4941-726d-4901-8376-1378bff7086f
s = Pluto.ServerSession()

# ╔═╡ b129f4c5-15d8-4530-b0d0-cc5beeb0b4e1
nb = Pluto.SessionActions.open(s, filename; run_async=false)

# ╔═╡ ec85b063-208f-4368-a6f1-b986a23466c1
Pluto.where_referenced(nb.topology, Set([:move]))

# ╔═╡ a748de7e-56db-4a01-9187-9ae8d8eb3a24
@bind whichcell_id Slider(nb.cell_order)

# ╔═╡ d6cb3de5-4b55-45c0-ac12-b3322da83b5d
nb.cells_dict[whichcell_id].code |> Text

# ╔═╡ a3dfac40-095f-49fc-a638-7c2d1e1b6dd3
fav_cell = nb.cells_dict[whichcell_id]

# ╔═╡ 4eeec5e7-13c9-4643-b54b-8fd3d987ae2a
