...
# ╔═╡ 143231ce-ac9e-11ef-2c5f-e1ddf26aa02d
using PenPlots, PlutoUI

# ╔═╡ 176efebb-5683-434f-bee8-6c672fc55eed
using Images

# ╔═╡ b501cdcd-8863-49e5-8db1-9b74a0e19c74
coords = [
	Point(i, sin(i/5) + rand())
	for i in 1:100
]

# ╔═╡ a3ea4f5a-6ad1-4a99-8d41-0ae877b8d8f3
Path(coords)

# ╔═╡ a0234707-265e-456b-9b17-b10c1a6ca2ca


# ╔═╡ 3a796c86-56c7-4b6d-b10b-793715350a1c
...
# ╔═╡ b8725568-7304-4110-baad-d4c09a29a93a
@bind scale Slider(0.9:.01:1.2)

# ╔═╡ d962ec41-4fec-4fb9-b89a-1a221f616f6b
offset, scale

# ╔═╡ 528fb133-cccf-4c88-9bde-c232fe4e1c8d
...
# ╔═╡ 3f2322f9-d986-4f0c-89e5-e1962baee886
spiral(special::Bool) = [
	if special
...
# ╔═╡ 3eca8e56-bc51-4d8f-8eb6-36846ef613eb
[
	# Path(spiral(false)),
	Path(spiral(true)),
...
manifest_format = "2.0"
project_hash = "356bb75c4c89f04cad9991215d55ae321d3ca3e2"
...
git-tree-sha1 = "d7cddd67536eb37136478bb6df3556a712d0c28f"
