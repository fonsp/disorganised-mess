...
# ╔═╡ de43b495-df8a-47b4-8db3-6eaa61c71571
begin
	using Plots
	Plots.default(linewidth=5, size=(600,200))
end

# ╔═╡ c436905c-8b8a-11ec-094d-d7eea510b7eb
using HypertextLiteral

# ╔═╡ 5d2a1c26-8da5-40b1-80f6-fa0e5915c629
using PlutoUI

# ╔═╡ 77c4e1a9-2bd6-401c-be7e-5cac28c61c93
md"""
# Tweening SVGs
...
# ╔═╡ c4ecd1a1-210f-4dec-b5bf-e6724215dcf5
md"""
## Example
"""

# ╔═╡ 4909f62f-7309-4f83-80ef-0c2c1fe6ce2c
@bind wow Slider(0:1:7)

# ╔═╡ 95c768d2-53a9-4b92-9097-bd9397c3c452
xs = sin.(0.5 * wow .* (1:.4:10))

# ╔═╡ 8b78a1a6-3320-4c61-a4ea-ba6942123ae9
md"""
## GIF recording

If you're viewing this online, here is a video:

![Schermopname 2022-02-12 om 02 03 13](https://user-images.githubusercontent.com/6933510/153689889-902a172c-9e8d-484e-b41c-30a76ed99016.gif)

"""

# ╔═╡ 5643c831-fa7b-4bec-bb8b-177d5f68737f
md"""
## More example!
"""

# ╔═╡ 4446db52-d6a6-42d2-a420-5682628e614c
@bind regenerate LabelButton("Generate new plot")

# ╔═╡ f99833d2-c644-4ec4-b2c7-676ae941eb4f
baseline = let
	regenerate
	rand(20)
end

# ╔═╡ 21454d92-e553-489e-9011-7310e512658e
big_data = let
	regenerate
	rand(50)
end

# ╔═╡ d92c420d-420a-4ed6-bf88-25f0e2365dec
@bind num Slider(1:50)

# ╔═╡ f0547156-84d3-4d40-aa07-67e63b61a0ec
# left = let
# 	regenerate
# 	demo_plot(rand(20); ylim=(0,1))
# end

# ╔═╡ bbc6a81c-5910-43e2-890b-206a44ce847b
md"""
## Two SVG files
"""

# ╔═╡ 37b55b5e-1899-4933-9c49-ef979f4daf25
@bind before FilePicker()

# ╔═╡ 13d777b6-2669-4ef4-8f45-c8055b3a1fb7
@bind after FilePicker()

# ╔═╡ 6ca9382e-c74d-401e-848f-1c1ac6ca075a
(
	before=Show(MIME"image/svg+xml"(), before["data"]),
	after=Show(MIME"image/svg+xml"(), after["data"])
)	

# ╔═╡ 604e8a1f-fdd4-4a91-835f-2726d7232f13


# ╔═╡ 8d0a6034-8b67-4c89-a250-1ad7c645bd1b
@htl("Show second image: $(@bind which html"<input type=checkbox>")")

# ╔═╡ 70fd490f-5be1-44dd-baa5-5f57b535f65d
md"""
# Appendix
"""

# ╔═╡ 91299d02-2551-4adf-ac9b-6a3b3725c4f4
begin
	struct PublishToJS
	x
	end
...
# ╔═╡ 9caf9f0e-db40-469c-a290-87c327aeb218
...
# ╔═╡ 4bb847ff-4692-4dee-be8a-2c6721d71fcb
plot(xs; ylim=(-1.1,1.1)) |> tweened_svg

# ╔═╡ b677eafa-74fc-47ab-9cf1-4bd0163f2617
left = let
	regenerate
...
# ╔═╡ 5be7bcb0-ead7-4744-b1eb-ba53ad447d10
