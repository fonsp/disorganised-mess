...
md"Let's zoom on the part where the growth seems linear on this semi-log plot:"
...
md"We can fit a straight line using **linear regression** to this portion of the data."
