...
# ╔═╡ b553cc94-ee3d-11ea-31c8-e14f20aed240
html"""
<style>
pluto-output p {
	font-family: cursive;
...
# ╔═╡ c9230ec0-ee30-11ea-00cd-7dca39fdf13e
@bind l Slider(0:5, show_value=true)
...
# ╔═╡ 3fc8ccfa-ee32-11ea-0426-fb9eb7e12f51
function pascal(n)
	if n <= 1
		[1.0]
	else
...
# ╔═╡ 1d9aab3a-ee32-11ea-1601-0bb734c3e915
gaussian_kernel.(0:5)
